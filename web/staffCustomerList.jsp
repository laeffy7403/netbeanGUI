...
<%
    ...
    try {
        ...
        if ("delete".equals(action) && idParam != null) {
            ...
            ps.executeUpdate();
            ps.close();
            response.sendRedirect("staffCustomerList.jsp?message=deleted");
            return;
        }
        ...
        if ("update".equals(action)) {
            ...
            ps.executeUpdate();
            ps.close();
            response.sendRedirect("staffCustomerList.jsp?message=updated");
            return;
        }
%>
...
<body>
      ...
      <main class="dashboard-main">
        <h1>Registered Customer Management (View Only)</h1><br>
