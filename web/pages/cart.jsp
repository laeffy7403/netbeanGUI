    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                // Fetch products
                String getCart = "SELECT c.*, p.image_url, p.category FROM CART c JOIN PRODUCTS p ON c.product_id = p.product_id WHERE customer_id = " + userId; //need change user ID, make it follow session
